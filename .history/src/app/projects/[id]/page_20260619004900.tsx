...
export default function ProjectDetailPage() {
     ...
     const totalBudgetPaid =
          project.paymentRecords?.reduce(
               (sum: number, r: any) =>
                    r.status === "COMPLETED"
     ...
     const tabItems = [
          // Tab 1: Thong tin & Thuyet minh
          {
               ...
               label: (
                    <span>
                         <FileTextOutlined /> Thông tin & Thuyết minh
                    </span>
               ),
               children: (
                    <Card>
                         ...
                         >
                              ...
                              <Descriptions.Item label="Bằng chữ" span={2}>
                                   <Text italic>
                                        {amountToWords(project.totalBudget)}
                                   </Text>
                              </Descriptions.Item>
                              ...
                              >
                                   <div
                                        dangerouslySetInnerHTML={{
                                             __html: project.fullText,
                                        }}
                                   />
                              </Card>
                         ) : (
                              <Empty
                                   description="Chưa có thuyết minh"
          ...
          // Tab 3: Ngan sach & Du toan
          {
               ...
               label: (
                    <span>
                         <DollarOutlined /> Ngân sách & Dự toán
                    </span>
               ),
               children: (
                    <>
                              ...
                              <Table
                                   ...
                                   columns={[
                                        ...
                                        },
                                        {
                                             ...
                                             render: () => (
                                                  <Space size="small">
                                                       <Tooltip title="Tạo hồ sơ thanh toán">
                                                            <Button
                                                                 type="text"
                                                                 size="small"
                                                                 icon={
          ...
          // Tab 4: Quyet dinh & San pham
          {
               ...
               label: (
                    <span>
                         <FileTextOutlined /> Quyết định & Sản phẩm
                    </span>
               ),
               children: (
                    <Row gutter={16}>
